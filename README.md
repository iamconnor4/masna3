...
This project condenses the knowledge that I have gotten from my years of industrial Haskell.
This pattern of a separate file-handling service has emerged over several companies where I worked, and I find this a well-scoped project to do pair-programming.

## 🍎 Documentation

See the [docs](./docs) directory for local development and architecture decisions.
